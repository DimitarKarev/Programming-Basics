...
namespace _11.Point_and_Rectangle
{
    public partial class Form1 : Form
    {
        ...
        private void Draw()
        {
            ...
            if (x > left && x < right && y > top && y < bottom) this.labelInside.Text = "Inside";
            else if (x < left || x > right || y < top || y > bottom) this.labelInside.Text = "Outside";
            else if ((x == left || x == right) && (y == top || y == bottom)) this.labelInside.Text = "Corner";
            else this.labelInside.Text = "Border";
            Visualize();
        }
